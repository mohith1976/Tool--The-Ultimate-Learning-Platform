...
$sql = "SELECT * from phyquestion   where question_id=:question_id";
//Prepare the query:
     ...
     <div class="input-group input-group-outline my-3">
       ...
       <div class="input-group input-group-outline my-3">
			 ...
			 <input type="text" class="form-control" id="question_title" placeholder="question_title" name="question_title"/>
			  ...
			  <div class="input-group input-group-outline my-3">
		     <label for="option_1"class="form-label"></label>
...
<a href="viewquestion1.php">Back</a></p>
<?php
...
// Query for Updation
$sql="update phyquestion set exam_number=:ti,question_title=:dt,option_1=:dur,option_2=:tq,option_3=:rn,option_4=:wrn,answer_option=:cre        where question_id=:question_id";
