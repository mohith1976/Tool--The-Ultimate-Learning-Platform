...
$sql = "SELECT * from chequestion   where question_id=:question_id";
//Prepare the query:
    ...
    <!-- offcanvas -->
     <main class="mt-5 pt-3">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
            <h4>Edit Chemistry questions</h4>
          </div>
        </div>
...
// Query for Updation
$sql="update chequestion set exam_number=:ti,question_title=:dt,option_1=:dur,option_2=:tq,option_3=:rn,option_4=:wrn,answer_option=:cre        where question_id=:question_id";
