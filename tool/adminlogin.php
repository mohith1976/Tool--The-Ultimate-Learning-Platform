...
if(isset($_POST['submit'])){
   ...
   $select = mysqli_query($conn, "SELECT * FROM `principal` WHERE username = '$username' AND password = '$password'") or die('query failed');
...
<body>
   <nav class="navbar navbar-expand-md r navbar-dark ">
         ...
         <h1 class="kol text-responsive">Thank you,for  logging in to Tool.</h1>
...
<div class="form-container">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <div class="form-group">
			 ...
			 <input type="varchar" class="form-control" id="password" placeholder="enter Password" name="password"required/>
			 <div class="invalid-feedback">Please fill out this field.
			 </div>
		     </div>
		   </div>  <br>
      ...
      <p>don't have an admin account? contact your principal to create one </p>
   </form>
