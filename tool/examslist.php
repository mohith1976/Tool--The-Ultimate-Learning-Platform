          ...
          <div class="col-md-12">
            <div class="card ">
              ...
              <div class="card-body">
			   ...
			   echo '<td><a href="deleteexams.php?del= '.$tetch['online_exam_id'].' "><button class="btn btn-danger btn-xs" onClick="return confirm("Do you really want to delete");"><span class="glyphicon glyphicon-trash"></span></button></a></td>';
