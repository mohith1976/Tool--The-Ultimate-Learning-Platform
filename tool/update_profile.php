...
if(isset($_POST['update_profile'])){
   ...
   mysqli_query($conn, "UPDATE `request` SET username = '$update_username', email = '$update_email' WHERE id = '$user_id'") or die('query failed');
...
<div class="form-container">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      ?>
		 ...
		 <div class="form-group">
		     <label for="number"> update Phone Number</label>
			 <input type="number" class="form-control" id="number" placeholder="enter Number" name="update_number"required/>
			 <div class="invalid-feedback">Please fill out this field.
			 </div>
		     </div>
     </div>
<div class="container text-center">		  
      ...
      <a href="principaldashboard.html">Back</a></p>
   </form>
</div>
<script>
