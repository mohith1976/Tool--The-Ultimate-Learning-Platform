...
<link href="https://fonts.googleapis.com/css2?family=Quicksand&display=swap" rel="stylesheet">
  ...
  <body>
   ...
   <?php
    ...
    <div class="card-body">
      <button><a href="update_userprofile.php" target="_parent" class="card-link">update profile</a></button>
      <button><a href="userlogin.php?logout=<?php echo $users_id; ?>" class="card-link" target="_parent">logout</a></button>
