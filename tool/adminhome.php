...
<html lang="en">
  ...
  <body>
      ...
      <div class="offcanvas-body p-0">
        <nav class="navbar-dark">
          <ul class="navbar-nav">
            ...
            <li>
              ...
              <div class="collapse" id="layouts">
                <ul class="navbar-nav ps-3">
                  <li>
                    <a href="admindashboard.html" target="_parent" class="nav-link px-3">
                      <span class="me-2"
                ...
                <li>
                    <a href="admindashboard.html" class="nav-link px-3">
                      <span class="me-2"
                        ><i class="bi bi-speedometer2"></i
                      ></span>
            ...
            <li>
              <a href="contactus.html" class="nav-link px-3">
   ...
   <?php
	  ...
	  <div class="card-body">
      <h5 class="card-title">User Name:  <?php echo $fetch['username']; ?></h5>
	  
      <h5 class="card-title">Password:  <?php echo $fetch['password']; ?></h5>
    <div class="card-body">
      <button><a href="update_adminprofile.php" target="_parent" class="card-link">update profile</a></button>
      <button><a href="adminlogin.php?logout=<?php echo $admin_id; ?>" class="card-link" target="_parent">logout</a></button>
      <p>New One! Ask your principal to create a new admin </p></div>
   </div>
