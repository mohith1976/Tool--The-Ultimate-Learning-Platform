          ...
          <div class="card h-100">
            <div class="card-header pb-0">
              ...
              <p class="text-sm">
                ...
                Upload<span class="font-weight-bold">your Notes  </span>to your Sr.Students
              </p>
            </div>
...
<div class="container text-center">		  
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST") {
        ...
        $sql = "INSERT INTO sr_pdf (file_name, file_content, file_size, file_type, college_number, title) VALUES ('$fileName', '$pdfContent', $fileSize, '$fileType', '$college_number', '$subject')";
...
<div class="container text-center">		  
        ...
        $subject = $_POST['title'];
        // Store the PDF content in the database
        $sql = "INSERT INTO srphy_pdf (file_name, file_content, file_size, file_type, college_number, title) VALUES ('$fileName', '$pdfContent', $fileSize, '$fileType', '$college_number', '$subject')";
        if ($conn->query($sql) === TRUE) {
            echo "<script>window.location.href='admindashboard.php'</script>";
        } else {
            echo "Error uploading file: " . $conn->error;
...
<div class="container text-center">		  
        ...
        $subject = $_POST['title'];
        // Store the PDF content in the database
        $sql = "INSERT INTO srche_pdf (file_name, file_content, file_size, file_type, college_number, title) VALUES ('$fileName', '$pdfContent', $fileSize, '$fileType', '$college_number', '$subject')";
        if ($conn->query($sql) === TRUE) {
            echo "<script>window.location.href='admindashboard.php'</script>";
        } else {
            echo "Error uploading file: " . $conn->error;
...
<div class="row mb-4">
          ...
          <div class="card h-100">
            <div class="card-header pb-0">
              ...
              <p class="text-sm">
                <i class="fa fa-arrow-up text-dark" aria-hidden="true"></i>
                Upload<span class="font-weight-bold">your notes  </span>to your Jr.Students
              </p>
            </div>
...
<div class="container text-center">		  
        ...
        $subject = $_POST['title'];
        // Store the PDF content in the database
        $sql = "INSERT INTO jr_pdf (file_name, file_content, file_size, file_type, college_number, title) VALUES ('$fileName', '$pdfContent', $fileSize, '$fileType', '$college_number', '$subject')";
        if ($conn->query($sql) === TRUE) {
           echo "<script>window.location.href='admindashboard.php'</script>";
        } else {
            echo "Error uploading file: " . $conn->error;
...
<div class="container text-center">		  
        ...
        $subject = $_POST['title'];
        // Store the PDF content in the database
        $sql = "INSERT INTO jrphy_pdf (file_name, file_content, file_size, file_type, college_number, title) VALUES ('$fileName', '$pdfContent', $fileSize, '$fileType', '$college_number', '$subject')";
        if ($conn->query($sql) === TRUE) {
           echo "<script>window.location.href='admindashboard.php'</script>";
...
<div class="container text-center">		  
        ...
        $subject = $_POST['title'];
        // Store the PDF content in the database
        $sql = "INSERT INTO jrche_pdf (file_name, file_content, file_size, file_type, college_number, title) VALUES ('$fileName', '$pdfContent', $fileSize, '$fileType', '$college_number', '$subject')";
        if ($conn->query($sql) === TRUE) {
            echo "<script>window.location.href='admindashboard.php'</script>";
        } else {
            echo "Error uploading file: " . $conn->error;
