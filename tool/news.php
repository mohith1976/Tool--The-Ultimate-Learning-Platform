   ...
   $check_message_query="select * from request WHERE college_number='$college_number'";  
    ...
    {  
     $insert = mysqli_query($conn,"INSERT INTO `adminmail`( college_number, admin_name, title, Message) VALUES( '$college_number','$admin_name','$title', '$Message')") or die('query failed');
	  ...
	  echo ' <a href ="admindashboard.php"></a>';
...
<div class="container text-center">		  
        ...
        <div class="col-lg-4 col-md-6">
          <div class="card h-100">
            <div class="card-header pb-0">
              <h6>Message Students</h6>
              <p class="text-sm">
                <i class="fa fa-arrow-up text-dark" aria-hidden="true"></i>
                <span class="font-weight-bold">Drop a Mail  </span>to your Sr.Students
              </p>
            </div>
			 <?php 
			  include 'Db_conection.php';
   ...
   $check_message_query="select * from request WHERE college_number='$college_number'";  
    ...
    if(mysqli_num_rows($run_query)>0)  
    {  
     $insert = mysqli_query($conn,"INSERT INTO `seniormail`( college_number, admin_name, title, Message) VALUES( '$college_number','$admin_name','$title', '$Message')") or die('query failed');
...
<div class="container text-center">		  
	      <input type="submit" name="submit1" value="submit"class="btn bg-gradient-dark w-100 my-4 mb-2" />
          ...
          <div class="card h-100">
            <div class="card-header pb-0">
              ...
              <p class="text-sm">
                <i class="fa fa-arrow-up text-dark" aria-hidden="true"></i>
                <span class="font-weight-bold">Drop a Mail  </span>to your Jr.Students
              </p>
            </div>
			 <?php 
			  include 'Db_conection.php';
   ...
   $check_message_query="select * from request WHERE college_number='$college_number'";  
    ...
    if(mysqli_num_rows($run_query)>0)  
    {  
     $insert = mysqli_query($conn,"INSERT INTO `juniormail`( college_number, admin_name, title, Message) VALUES( '$college_number','$admin_name','$title', '$Message')") or die('query failed');
...
<div class="container text-center">		  
	      <input type="submit" name="submit11" value="submit"class="btn bg-gradient-dark w-100 my-4 mb-2" />
