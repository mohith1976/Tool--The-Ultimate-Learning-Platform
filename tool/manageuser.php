          ...
          <div class="col-md-12">
            <div class="card ">
              <div class="card-header">
                <h4 class="card-title"> Jr.Students</h4>
              </div>
              ...
              <div class="card-body">
                ...
                if(mysqli_num_rows($select) > 0){
				 ...
				 $college_number =  $fetch['college_number']; 
				  $telect = mysqli_query($conn, "SELECT * FROM `user` WHERE college_number = '$college_number'") or die('query failed');
			   ...
			   echo '<tr>';
			   echo '<td>' .$tetch['id']. '</td>';
			   echo '<td>' .$tetch['username']. '</td>';
			   echo '<td>' .$tetch['password']. '</td>';
			   
			
			   
			   echo '<td><a href="deleteuser.php?del= '.$tetch['id'].' "><button class="btn btn-danger btn-xs" onClick="return confirm("Do you really want to delete");"><span class="glyphicon glyphicon-trash"></span></button></a></td>';
