          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Exams table</h6>
              </div>
            </div>
              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Total Question</th>
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Right Answer Mark</th>
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Wrong Answer Mark</th>

                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">EXAM STATUS</th>
                ...
                if(mysqli_num_rows($select) > 0){
				 ...
				 $college_number =  $fetch['college_number']; 
				  $telect = mysqli_query($conn, "SELECT * FROM `online_exam_table` WHERE college_number = '$college_number'") or die('query failed');
				 
				 if(mysqli_num_rows($telect) > 0){
                 while( $tetch = mysqli_fetch_assoc($telect)) {
				 echo '<tbody>';
			   echo '<tr>';
			   echo '<td>' .$tetch['online_exam_id']. '</td>';
			      echo '<td>' .$tetch['exam_number']. '</td>';
			   echo '<td>' .$tetch['online_exam_title']. '</td>';
			   echo '<td>' .$tetch['online_exam_datetime']. '</td>';
			   echo '<td>' .$tetch['online_exam_duration']. '</td>';
			   echo '<td>' .$tetch['total_question']. '</td>';
			   echo '<td>' .$tetch['marks_per_right_answer']. '</td>';
			   echo '<td>' .$tetch['marks_per_wrong_answer']. '</td>';
			   echo '<td>' .$tetch['online_exam_status']. '</td>';
			   echo '<td>' .$tetch['online_exam_created_on']. '</td>';
               
             echo '<td><a href="question1.php?id=' .$tetch['online_exam_id'].' "><button class="btn  mb-0 text-white bg-gradient-info shadow-dark btn-xs">Add Question</button></a><br>
	 	  <a href="viewquestion1.php?question_id= ' .$tetch['online_exam_id']. '"><button class="btn  mb-0 text-white bg-gradient-warning shadow-dark btn-xs">View Question</button></a></td>';

          echo '<td><a href="getresult.php?id= '.$tetch['online_exam_id']. '"><button class="btn  mb-0 text-white bg-gradient-primary shadow-dark btn-xs">Result</button></a></td>';

			  echo '<td><a href="updateexam.php?online_exam_id=' .$tetch['online_exam_id']. '"><button class=" btn  mb-0 text-white bg-gradient-dark shadow-dark btn-xs">edit exam</button></a></td>';
