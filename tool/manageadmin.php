              ...
              <div class="card-body">
                ...
                if(mysqli_num_rows($select) > 0){
				 ...
				 $college_number =  $fetch['college_number']; 
				  $telect = mysqli_query($conn, "SELECT * FROM `principal` WHERE college_number = '$college_number'") or die('query failed');
			   ...
			   echo '<td><a href="deleteadmin.php?del= '.$tetch['id'].' "><button class="btn btn-danger btn-xs" onClick="return confirm("Do you really want to delete");"><span class="glyphicon glyphicon-trash"></span></button></a></td>';
