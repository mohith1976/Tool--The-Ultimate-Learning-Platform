...
<div class="form-container">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <div class="form-group">
			 ...
			 <input type="number" class="form-control" id="password" placeholder="enter Password" name="password"required/>
			 <div class="invalid-feedback">Please fill out this field.
			 </div>
		     </div>
		   </div>  <br>
      ...
      <p>don't have an user account? contact your principal to create one </p>
   </form>
